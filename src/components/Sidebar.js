...
const Sidebar = () => {
    return (
        <div className="w-64 h-screen bg-orange-400 text-white fixed top-0 left-0 shadow-lg">
            <h2 className="text-2xl font-bold p-6 border-b border-orange-300">Admin Dashboard</h2>
            <nav className="mt-10">
                <ul>
